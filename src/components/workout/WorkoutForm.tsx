...
interface WorkoutFormProps {
  ...
  onSubmit: (workout: WorkoutPlan | Omit<WorkoutPlan, 'id'>) => void;
}

const WorkoutForm: React.FC<WorkoutFormProps> = ({ initialWorkout, onSubmit }) => {
        ...
        {selectedExercises.length > 0 ? (
          ...
          <div className="text-center py-6 border border-dashed rounded-md">
            ...
            <Button 
              ...
              variant="outline" 
              className="mt-2"
              onClick={() => handleAddExercise(exercises[0]?.id || '')}
            >
